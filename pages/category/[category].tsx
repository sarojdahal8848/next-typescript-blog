...
import { cleanSlug, debounce, stringFirstLetterCaptalize } from "../../utils";
...
const Category: NextPage<IPropTypes> = ({ categories, articles, slug }) => {
  ...
  const formattedCategory = (slug: string) => {
    return stringFirstLetterCaptalize(cleanSlug(slug));
  };
  ...
  return (
    <>
      <Head>
        <title>{formattedCategory(slug)} | My Blog</title>
